...
LAYOUTS = {
    ...
    5: [
        ...
        Slot(x=0.03, y=0.06, w=0.18, h=0.34, role_label="MODERATOR"),
        Slot(x=0.25, y=0.02, w=0.16, h=0.28),
        Slot(x=0.44, y=0.02, w=0.16, h=0.28),
        Slot(x=0.63, y=0.02, w=0.16, h=0.28),
        Slot(x=0.25, y=0.58, w=0.16, h=0.28),
    ],
    6: [
        # 1 moderator + 5 panelists, 2 rows - mirrors Image 1 / Image 3 style
        Slot(x=0.03, y=0.18, w=0.16, h=0.28, role_label="MODERATOR"),
        Slot(x=0.23, y=0.02, w=0.14, h=0.24),
        Slot(x=0.41, y=0.02, w=0.14, h=0.24),
        Slot(x=0.59, y=0.02, w=0.14, h=0.24),
        Slot(x=0.23, y=0.56, w=0.14, h=0.24),
        Slot(x=0.41, y=0.56, w=0.14, h=0.24),
    ],
    7: [
        Slot(x=0.02, y=0.18, w=0.14, h=0.26, role_label="MODERATOR"),
        Slot(x=0.18, y=0.02, w=0.12, h=0.22),
        Slot(x=0.32, y=0.02, w=0.12, h=0.22),
        Slot(x=0.46, y=0.02, w=0.12, h=0.22),
        Slot(x=0.60, y=0.02, w=0.12, h=0.22),
        Slot(x=0.18, y=0.58, w=0.12, h=0.22),
        Slot(x=0.32, y=0.58, w=0.12, h=0.22),
    ],
    8: [
        Slot(x=0.02, y=0.18, w=0.13, h=0.26, role_label="MODERATOR"),
        Slot(x=0.17, y=0.02, w=0.11, h=0.22),
        Slot(x=0.30, y=0.02, w=0.11, h=0.22),
        Slot(x=0.43, y=0.02, w=0.11, h=0.22),
        Slot(x=0.56, y=0.02, w=0.11, h=0.22),
        Slot(x=0.17, y=0.56, w=0.11, h=0.22),
        Slot(x=0.30, y=0.56, w=0.11, h=0.22),
        Slot(x=0.43, y=0.56, w=0.11, h=0.22),
    ],
}
